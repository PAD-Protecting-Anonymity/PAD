...
for i in range(0,7):
    ...
    pickle.dump([out, framework.generated_data_description(), loss_metric,anonymity_level, timeTaken], open('./results/line count/after/PAD_results_line_counter_Day_OutputHour_fold_'+str(i)+'.pickle', "wb"))
