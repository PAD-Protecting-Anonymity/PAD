...
for i in range(0,7):
    ...
    pickle.dump([out, framework.generated_data_description(), loss_metric,anonymity_level,timeOut], open('./results/presence/after/PAD_results_day_OutputHour'+inputFile+'_fold_'+str(i) +'.pickle', "wb"))
