...
day_profile2 = day_profile1.iloc[90:300,0::4]  # subsample the database to improve the speed for demonstration purpose
...
for n in range(2, 8):
    ...
    with open('result_scripts/loss_vs_privacy_energy_usage_public_deep_mc_high.pickle', 'wb') as f:
