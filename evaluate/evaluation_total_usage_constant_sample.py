...
def evaluation_total_usage(n):
    ...
    day_profile = day_profile.iloc[0:90*(n-1),0::4] # subsample the database to improve the speed for demonstration purpose
...
with open('result_scripts/loss_vs_privacy_usage_SCS_5_constsample_deep.pickle', 'wb') as f: 
